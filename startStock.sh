...
if [ $DB_IS_RUN -lt 2 ]; then
    ...
    ####################### 创建数据库 #######################
    echo "wait 10 second , and create mf_stock_data_system database ."
    sleep 10
...
echo "starting mf_stock_data_system ..."
# /data/stock 是代码目录 -v /data/stock:/home/royburns/workspace/muddyfishing/mf_stock_data_system 是开发模式。
